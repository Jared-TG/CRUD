...
export class AutService {
  ...
  updateUser(id: number, userData: RegisterData): Observable<seccionUser> {
    return this.http.put<seccionUser>(`${environment.apiurl}/auth/users/${id}`, userData, { headers: this.getAuthHeaders() });
  }
